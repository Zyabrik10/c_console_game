...
{
    printf("\n In the heart of the forest, he encountered a pack of werewolves, their mournful howls reverberating through the trees. (Press enter) \n");
    makePause();
}
...
{
    printf("\n Through the twisted, gnarled trees of the Cry Forest, the knight forged ahead, the eerie silence broken only by the distant howls of unseen creatures. (Press enter)\n");
    makePause();
...
{
    printf("\n Further into the forest, the knight stumbled upon the third challenge—a massive, slithering serpent. (Press enter)\n");
    makePause();
}
...
void print_level_1_history_4_end()
{
    ...
    makePause();
    printf(" 'Take that, you scaly beast!' the knight shouted triumphantly as he vanquished the serpent, its death throes a symphony of echoing hisses. (Press enter)\n");
    makePause();
}
...
void print_level_1_history_5_start()
{
    ...
    makePause();
    printf(" Its deafening roar pierced the air, making the very ground shake. (Press enter)\n");
    makePause();
